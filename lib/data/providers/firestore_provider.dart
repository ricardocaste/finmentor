...
import 'package:finmentor/infrastructure/firestore_utils.dart';
...
class FirestoreProvider {
  ...
  Future<Null> updateAppUser(User user) async {
    user.updatedAt = Timestamp.now();
    await _firestore.collection('users').doc(user.uid).update(user.toJson());
  }
 
  Future<Null> updateAvatarUser(String uid, String photoUrl) async {
